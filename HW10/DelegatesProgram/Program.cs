...
public class ExecutionManager
{
    ...
    {
        // why I have to do something with it?
    }
    public void PrepareExecution()
    {
        //fill dictionary here
        // why I have to do something with it (I had filled dictionary using constructor )?
    }
    public int Execute(Operation operation)
    {
...
class Program
{
    ...
    {
        var opManager = new ExecutionManager(20, 10);
